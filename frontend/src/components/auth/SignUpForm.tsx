...
const SignUpForm: React.FC<SignUpFormProps> = ({ onSignUp, loading = false, error = null }) => {
      ...
      <Card className="relative overflow-hidden border-0 shadow-xl bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-950">
        ...
        <CardHeader className="relative z-10 text-center pb-4">
          ...
          <CardDescription className="text-gray-600 dark:text-gray-400 mt-2">
            Join us today to get started with your productivity journey
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`h-12 rounded-xl border-0 bg-gray-50 dark:bg-gray-800/50 backdrop-blur-sm px-4 py-3 text-base transition-all duration-300 focus:ring-2 focus:ring-blue-500 focus:shadow-lg ${errors.confirmPassword ? 'focus:ring-red-500' : ''}`}
                />
                {errors.confirmPassword && <p className="text-red-500 text-xs mt-1.5 ml-0.5">{errors.confirmPassword}</p>}
              </div>
            </div>
          </CardContent>
          <CardFooter className="relative z-10 flex flex-col gap-4 pt-2">
            ...
            <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <a href="/auth/signin" className="text-blue-600 dark:text-blue-400 font-medium hover:underline transition-all duration-200">
                Sign in
              </a>
            </p>
          </CardFooter>
